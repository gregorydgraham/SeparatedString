 ...
 */
public class SeparatedFormattedStringTest {

  public SeparatedFormattedStringTest() {
  }

  @Test
  public void testSimpleDateFormatting() {
    SeparatedFormattedString sepString = new SeparatedFormattedString().separatedBy(", ");
